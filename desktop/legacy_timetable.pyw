...
# ==========================================
SUPABASE_URL = "https://fnbzrxzgynuxgwretwux.supabase.co"
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZuYnpyeHpneW51eGd3cmV0d3V4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzUwNjc1MjUsImV4cCI6MjA5MDY0MzUyNX0.xnKjiURzvfCpqIlyQR_wRvNh6goupqOl3b5j_4xhXKU"
...
class TimetableWidget:
    ...
    def load_images(self):
        ...
        png_logo = os.path.join(self.base_dir, 'logo.png')
        ico_logo = os.path.join(self.base_dir, 'logo.ico')
        try:
    ...
    def load_academic_csv(self):
        ...
        try:
            ...
            reader = list(csv.reader(decoded_text.splitlines()))
            if not reader: 
                return
